  ...
  list: [
    {
      ...
      iconPath: "static/tab/all.png",
      selectedIconPath: "static/tab/all_se.png"
    },
    {
      text: "",
      pagePath: "pages/settings/page",
      iconPath: "static/tab/config.png",
      selectedIconPath: "static/tab/config_se.png"
    }
  ]
};
const globalStyle = {
  navigationBarTextStyle: "black",
  navigationBarTitleText: "Dashbord",
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.3.9"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"mycloud","spaceId":"mp-12324886-c8aa-4f83-8990-444f0a2a460e","clientSecret":"yW33ai/u0+zX53SbGSbxyA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__9BF3038";
} catch (e2) {
